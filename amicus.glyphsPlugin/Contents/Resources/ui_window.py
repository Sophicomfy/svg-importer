...
class AmicusWindow:
    def __init__(self):
        ...
        self.w.batchImportButton = Button((15, 40, 180, 20), "Batch Import", callback=self.batchImportCallback)        self.w.selectiveImportButton = Button((15, 70, 180, 20), "Selective Import", callback=self.dummyCallback)
