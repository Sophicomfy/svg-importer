...
class AmicusWindow:
    def __init__(self):
        self.w = Window((400, 260), "Amicus SVG Importer")
        ...
        self.w.postProcessText = TextBox((15, 130, -15, 17), "Choose post-process option:", sizeStyle='small')
        
        self.w.postProcessButton = Button((15, 150, 180, 20), "Post Process Paths", callback=self.postProcessCallback)
        self.w.renameGlyphsButton = Button((15, 180, 180, 20), "Rename Glyphs", callback=self.renameGlyphsCallback)
        self.w.cancelButton = Button((15, 210, 180, 20), "Cancel", callback=self.closeWindow)
        self.w.open()
